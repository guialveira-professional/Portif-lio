...
The combination of these factors has given me the freedom to study technology in various fields. My favorites are data, computing, production, eletronic, robotics, finance, and people management. Throughout my professional journey so far, I have had the opportunity to see and demonstrate how IT combined with business knowledge can be extremely effective and productive. It can contribute exceptionally to matters that require a more refined storytelling.
